...
class testRecoveryUsingSimpleLabelledKey(unittest.TestCase):
	...
	def sample3(self):
		...
		vault.append(self.key12t3)
		#print(vault.toString())
		self.sampleOutcome(vault, self.passwordListA0, self.passwordListA0)
		return
	...
	def sample4(self):
		...
		print(vault.toString())
		vault.append(self.key12t3)
		vault.append(self.key12t5)
		#print(vault.toString())
		self.sampleOutcome(vault, self.passwordListA2, self.passwordListX)
		return
	...
	def sample5(self):
		...
		vault.append(self.key12t5)
		#print(vault.toString())
		self.sampleOutcome(vault, self.passwordListA1, self.passwordListA1)
		return
