...
class MyWindow(QWidget):
	def __init__(self, *args):
		...
		#tableview.horizontalheader().setSectionResizemode(qtgui.qheaderview.stretch)
		#tableview.setSizePolicy(QSizePolicy)
		#tableview.horizontalHeader()  .setResizeMode(QtGui.QHeaderView().Stretch)
		
		layout = QHBoxLayout(tab1)
		layout.addStretch(1)
		#layout.layoutStretch(1)
